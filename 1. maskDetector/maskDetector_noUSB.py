    ...
    for idx, f in enumerate(face):
        ...
        if 0 <= startX <= frame.shape[1] and 0 <= endX <= frame.shape[1] and 0 <= startY <= frame.shape[0] and 0 <= endY <= frame.shape[0]:
            ...
            if prediction < 0.5: # 마스크 미착용으로 판별되면,
                ...
                cv2.putText(frame, "Plese wear your mask!", (10,40), font, fontScale, fontColor, lineThickness)
                ...
                cv2.putText(frame, "Welcome!", (10,40), font, fontScale, fontColor, lineThickness)
